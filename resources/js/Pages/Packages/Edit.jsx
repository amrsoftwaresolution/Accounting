...
export default function Edit({ package: pkg }) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        max_companies: pkg.max_companies || 1,
        max_chart_of_accounts: pkg.max_chart_of_accounts || '',
        max_products: pkg.max_products || '',
        max_users: pkg.max_users || '',
        max_invoices_per_month: pkg.max_invoices_per_month || '',
    ...
    return (
        <AuthenticatedLayout header={`Edit Package: ${pkg.name}`}>
