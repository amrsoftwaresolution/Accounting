...
export default function ItemList({ items: initialItems }) {
    ...
    const SortIcon = ({ columnKey }) => {
        ...
        return sortConfig.direction === 'asc'
            ? <svg className="h-3 w-3 ml-1 text-primary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 15l7-7 7 7" /></svg>
            : <svg className="h-3 w-3 ml-1 text-primary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7" /></svg>;
    };
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-3">
                                                <div className="h-10 w-10 rounded-lg bg-slate-100 flex items-center justify-center text-slate-300 overflow-hidden border border-slate-200 group-hover:border-primary-200 transition-colors relative">
                                                    ...
                                                    <button
                                                        onClick={handleOpenCreate}
                                                        className="absolute inset-0 bg-primary-600/90 text-white flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity"
                                                ...
                                                <div>
                                                    <div className="text-sm font-bold text-slate-900 group-hover:text-primary-600 transition-colors">{item.name}</div>
