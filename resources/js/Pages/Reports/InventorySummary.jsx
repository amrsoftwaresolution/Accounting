                ...
                <table className="w-full text-[13px] text-left border-collapse table-fixed">
                    <thead>
                        <tr className="border-y-2 border-gray-300">
                            <th className="py-2.5 px-3 font-semibold text-gray-900 w-[40%]">
                                Product / Service
                            </th>
                            ...
                            groups.map((group, groupIdx) => {
                                ...
                                return (
                                    <React.Fragment key={groupIdx}>
                                        ...
                                        >
                                            <td colSpan="5" className="py-2 px-3 font-bold text-gray-800">
                                        ...
                                        {!isCollapsed && group.items.map((item, index) => (
                                            <tr key={index} className="hover:bg-gray-50 transition-colors bg-white">
                                                <td className="py-2 px-3 text-gray-900 font-medium pl-10">
                                                    <Link href={route('reports.inventory-detail-all')} className="hover:underline cursor-pointer decoration-slate-400 underline-offset-4 text-primary">
                                                        {item.name}
                                                    </Link>
                                                </td>
