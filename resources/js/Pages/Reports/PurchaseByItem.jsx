...
export default function PurchaseByItem({ reportData, filters, auth }) {
    ...
    const handleExportExcel = () => {
        ...
        csvContent += `"Item Name","Quantity Purchased","Total Amount (${homeCurrency})"\n`;
        ...
        link.setAttribute("download", `Purchase_By_Item.csv`);
    ...
    return (
        ...
        >
            <Head title="Purchase By Item" />

            <div className="text-center mb-8 font-serif">
                <h2 className="text-xl font-bold text-gray-900">Purchase By Item</h2>
                ...
                <table className="w-full text-[13px] text-left border-collapse">
                    <thead>
                        <tr className="border-y-2 border-gray-300">
                            ...
                            <th className="py-2.5 px-3 font-semibold text-gray-900 text-right">Quantity Purchased</th>
