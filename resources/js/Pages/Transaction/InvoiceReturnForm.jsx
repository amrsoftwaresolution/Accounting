...
export default function InvoiceReturnForm({ auth, nextInvoiceReturnNo = "", creditNote = null }) {
...
const actionRef = useRef('save');
    ...
    const { data, setData, post, patch, processing, errors, reset, clearErrors, transform } = useForm({
        ...
        creditNoteNo: creditNote?.creditNoteNo || (nextInvoiceReturnNo ? String(parseInt(nextInvoiceReturnNo)).padStart(4, '0') : "1001"),
    ...
    useEffect(() => {
        if (creditNote) {
            ...
            setData(prev => ({
                ...
                creditNoteNo: nextInvoiceReturnNo ? String(parseInt(nextInvoiceReturnNo)).padStart(4, '0') : "1001",
                memo: "",
                statementMessage: "",
                items: [
                    { product: "", description: "", qty: "1", rate: "0.00", amount: "0.00" },
        ...
        clearErrors();
    }, [creditNote?.id, nextInvoiceReturnNo]);
